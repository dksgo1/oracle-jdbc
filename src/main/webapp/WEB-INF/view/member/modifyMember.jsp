                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" id="exampleInputIcon4" name="memberId" value="${loginMember.memberId}" readonly="readonly" type="text" aria-label="email adress">
                                        </div>
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-group">
                                        ...
                                        <!-- Form -->
                                        <div class="form-group">
                                            <label for="exampleConfirmPassword7">현재 이름</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><span class="fas fa-unlock-alt"></span></span>
                                                </div>
                                                <input class="form-control" id="exampleConfirmPassword7" name="name" value="${loginMember.memberName}" readonly="readonly" type="text" aria-label="Password" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleConfirmPassword7">변경할 이름</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><span class="fas fa-unlock-alt"></span></span>
                                                </div>
                                                <input class="form-control" id="exampleConfirmPassword7" name="memberName" type="text" aria-label="Password" required>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-block btn-primary">개인정보 수정</button>
                               </form>
                            </div>
                        </div>
                    </div>
